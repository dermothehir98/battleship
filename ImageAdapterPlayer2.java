...
public class ImageAdapterPlayer2 extends BaseAdapter {
    private Context mContext;

    public ImageAdapterPlayer2(Context c) {
        mContext = c;
    }

    public int getCount() {
        return mThumbIdsP2.length;
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        imageView.setImageResource(mThumbIdsP2[position]);
        return imageView;
    }

    public static Integer[] mThumbIdsP2 = {
