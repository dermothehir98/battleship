...
public class P2AttackAdapter extends BaseAdapter {
    private Context mContext;

    public P2AttackAdapter(Context c) {
        mContext = c;
    }

    public int getCount() {
        return mThumbIdsA2.length;
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        imageView.setImageResource(mThumbIdsA2[position]);
        return imageView;
    }

    public static Integer[] mThumbIdsA2 = {
